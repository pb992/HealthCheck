  ...
  <form class="w-75 my-3 border border-primary p-5 rounded-4" action="/registry/update" method="post">
    <h1 id="title" class="my-2 pb-3 d-flex justify-content-center" style="color: #002B7E;">Anagrafica</h1>
        ...
        <div class="row mb-3">
                   ...
                   <div class="col-sm-10">
                       <input type="text" id="name" name="name" <%if(registry.getName()!= null ){%>value="<%=registry.getName()%>"<%}%> class="form-control" required>
                   </div>
               </div>
               ...
               <div class="row mb-3">
                   ...
                   <div class="col-sm-10">
                       <input type="text" id="surname" name="surname" <%if(registry.getSurname()!= null ){%>value="<%=registry.getSurname()%>"<%}%> class="form-control" required>
                   </div>
               </div>
               ...
               <div class="row mb-3">
                   ...
                   <div class="col-sm-10">
                       <input type="date" id="birthDate" name="birthDate" <%if(registry.getBirthDate()!= null ){%>value="<%=registry.getBirthDate()%>"<%}%> class="form-control" required max="<%= java.time.LocalDate.now() %>">
                   </div>
               </div>
              ...
              <div class="row mb-3">
               ...
               <div class="row mb-3">
                   ...
                   <div class="col-sm-10">
                       <input type="text" id="nationality" name="nationality" maxlength="2" <%if(registry.getNationality()!= null ){%>value="<%=registry.getNationality()%>"<%}%> class="form-control" required>
                   </div>
               </div>
               ...
               <div class="row mb-3">
                   ...
                   <div class="col-sm-10">
                       <input type="text" id="city" name="city" <%if(registry.getCity()!= null ){%>value="<%=registry.getCity()%>"<%}%> class="form-control" required>
                   </div>
               </div>
               ...
               <div class="row mb-3">
                   ...
                   <div class="col-sm-10">
                       <input type="text" id="address" name="address" <%if(registry.getAddress()!= null ){%>value="<%=registry.getAddress()%>"<%}%> class="form-control" required>
                   </div>
               </div>
               ...
               <div class="row mb-3">
                   ...
                   <div class="col-sm-10">
                        <input type="text" id="cf" name="cf" maxlength="16" <%if(registry.getCf()!= null ){%>value="<%=registry.getCf()%>"<%}%> class="form-control" required>
                   </div>
               </div>
